 ...
 try
{
 	...
 	System.out.println("Category page product name is"+category_id);
 	...
 	String sql="select p.PRODUCT_ID,p.CATEGORY_ID,p.SUBCATEGORY_ID,p.BRAND_ID, "
			...
			+"p.CASH_ON_DELIVERY,p.WARRENTY,p.SHIPPING_COST,p.REPLACEMENT_WARRENTY,p.PRODUCT_UPDATED,b.BRAND_NAME from products p inner join brand b on p.BRAND_ID=b.BRAND_ID where PRODUCT_NAME=?";
