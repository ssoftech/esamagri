...
<div class="form">
      ...
      <ul class="tab-group">
        <li class="tab active"><a href="Admin_Signup.jsp">Sign Up</a></li>
        <li class="tab"><a href="Admin_Login.jsp">Log In</a></li>
      </ul>
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <form action="Admin_Reg" method="post" enctype="multipart/form-data">
          ...
          <a href="Admin_Login.jsp"><button type="submit" class="button button-block"/>Submit</button></a>
