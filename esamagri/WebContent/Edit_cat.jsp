...
<div class="mainwrapper">
  ...
  <div id= "apDiv1" >
  <form method="post" action="Update_cat">
  <% String CATEGORY_NAME=request.getParameter("cid");
...
%>
<table>
<tr><td>CATEGORY_NAME</td><td>&nbsp;&nbsp;&nbsp;</td>
<td><input type="text" name="CATEGORY_NAME"  value="<%=CATEGORY_NAME%>" size=20  ></td>
<td><input type="hidden" name="CATEGORY_ID" value=<%=rs.getString("CATEGORY_ID") %>></td>
<td colspan="2" >
<td><input type="submit" class="btn-info" value="update">
</td>
