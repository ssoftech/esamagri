...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.Retailer_returnbean,java.util.*"%>
    <%@page import="model.Retailer_returnModel"%>
    <%@page import="java.util.Iterator"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>RETAILER RETURNS</title>
...
<body class="skin-blue">
 ...
 -->                  <!-- </ul>
  ...
  <h2 align="center" >Product Returns</h2><br><br>
   <%try
{
ArrayList<Retailer_returnbean> ar=Retailer_returnModel.showReturns(name);
if(ar!=null)


                    
                                  
{%><div id="show"><center><table border="3" style="width:600px;height:50px; align="> <tr><th>Order ID</th><th>Email</th><th>Product Name</th><th>Supplier Id</th>
                            </center> <th>Reason</th>
                            </tr>
                    
                   
  
	<% Iterator<Retailer_returnbean> it=ar.iterator();
	
	while(it.hasNext())
	{
		Retailer_returnbean ob=it.next();
