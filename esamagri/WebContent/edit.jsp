...
<html>
 <head>
        <meta charset="UTF-8">
        <title>RETAILER EDIT PRODUCTS | Dashboard</title>
...
<div class="box box-info">
        ...
        <div>
<form action="Update_Product1" method="POST" >
<table id="product_table"  border="1" style="width:558px;height:635px;  margin-top:6px;  ">
<tr>
<td colspan="2" style="text-align: center;"><h3><u>Product Details</u></h3></td>
</tr>
...
<td><input type="text" name="SUBCATEGORY_ID" value="<%=rs.getString("SUBCATEGORY_ID")%>" size=20 ></td>
</tr>
<tr><td>BRAND_ID</td>
<td><input type="text" name="BRAND_ID" value="<%=rs.getString("BRAND_ID") %>" size=20 ></td>
</tr>
<tr><td>PRODUCT_NAME</td>
<td><input type="text" name="PRODUCT_NAME" value="<%=rs.getString("PRODUCT_NAME") %>" size=20 ></td>
</tr>
...
<td><input type="text" name="COMPANY_NAME" value="<%=rs.getString("SUPPLIER_ID") %>" size=20 ></td>
</tr>
...
<div>
<table id="color_table"  style="width:120px; height:300px; margin-left:600px; margin-top:-635px; ">
<tr>
<td colspan="2" style="text-align: center;"><h3><u>Color and Quantity</u></h3></td>
</tr>
...
System.out.println("Product id is"+Product_Id1);
...
{
%>
<form action="Update_Quantity1" method="POST"> 
...
<table id="image_table"  style="width:300px; height:300px;  margin-left:635px; margin-top:10px;">
<tr>
<td colspan="2" style="text-align: center;"><h3><u>Color and Image</u></h3></td>
</tr>
<tr><td>PRODUCT_ID</td>
<td><input type="text" name="PRODUCT_ID" value="<%=Product_Id%> " size=20  readonly="readonly"></td>
</tr>
...
{
%>
<form action="edit_Image.jsp" method="get">
