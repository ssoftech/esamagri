...
<div class="mobile6b">
 ...
 <%
						...
						String sql = "Select  DISTINCT ad1.PRODUCT_ID, ad1.COLOR from image ad1 inner join products ad2 on ad1.PRODUCT_ID=ad2.PRODUCT_ID and BRAND_ID=?";
				...
				<tr>
					<%-- <td><a
						href="singleproduct.jsp?PRODUCT_ID=<%=PRODUCT_ID%> &subcategory_id=<%=subcategory_id%> &COLOR=<%=COLOR%> &SALES_PRICE=<%=SALES_PRICE%> &FILE_NAME=<%=FILE_NAME%>"> --%>
							 <td >   &nbsp;&nbsp;&nbsp;   <a href="singleproduct.jsp?product_id=<%=PRODUCT_ID%>&filename=<%=FILE_NAME%>&Product_Name=<%=PRODUCT_NAME%>"><img src="Image4?brand=<%=PRODUCT_ID%>" height="340" width="240"  ></a></td>
				...
				<tr>
					<td
						style="color: white; text-shadow: 3px 2px 5px black; font-size: 18px; padding-bottom: 3px;">&nbsp&nbsp<%=COLOR%></td>
				</tr>
				<tr>
					<td style="color: white; text-shadow: 3px 2px 5px black;">&nbsp&nbsp<i
						class="fa fa-inr fa-lg"></i>&nbsp&nbsp<%=SALES_PRICE%></td>
