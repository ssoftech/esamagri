...
<form action="Update_Image2" method="POST" enctype="multipart/form-data">
<table id="image_table"  style="width:700px; hight:300px; margin-top:-300px; margin-left:400px; ">
...
<td><%=COLOR%>
<td>
<input type="hidden" name="COLOR" value="<%=COLOR%>" size=20 >
