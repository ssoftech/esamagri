<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.*"%>
    <%@page import="model.retailer_dtls_model"%>
...
<br>
                <!-- <h6 class="widgettitle">Registered Customer </h6>
                ...
                <h6 class="widgettitle">Retailer </h6><br>
                
                
                  <%try
{
ArrayList<retailer_dtls_bean> ar=retailer_dtls_model.showretailer();
if(ar!=null)
{%><div > 
             ...
             <% Iterator<retailer_dtls_bean> it=ar.iterator();
	
	while(it.hasNext())
	{
		retailer_dtls_bean ob=it.next();
