...
setInterval(GetClock,1000);
 ...
 var theone
for (i=0;i<document.add.check;i++){
	
	if (document.add.check[i].checked==true){
	theone=i
 ...
 <div class="mainwrapper">
    ...
    <div class="rightpanel">
       ...
       <span style="font-size:150%;color:red;">&starf;</span>
          ...
          <div class="field-wrap"> Profile Picture
...
<form name="add" action="sub_admin" method="post" >
<table style="margin-left: 300px; margin-top: 40px">
<caption>
   <h2> subadmin-power</h2>
    </caption>
<tr>
<td>SubAdmin Name</td>
<td>
     ...
     <option selected="selected">sub-admin</option>
       <% String sql21="Select USER_NAME from sub_admin_info";
          Connection con21=Db.Condb();
   
   PreparedStatement ps21=con21.prepareStatement(sql21);
   ResultSet rs21=ps21.executeQuery();
   while(rs21.next())
   {
	   String name1=rs21.getString("USER_NAME");%>
	 <option value="<%=rs21.getString("USER_NAME")%>"><%=name1%></option> 
<%} %>
    </select>
   </td>
</tr>
...
<tr>
<td>Edit <input type="checkbox" name="check1" value="Edit"> <br></td>
<td>Delete<input type="checkbox" name="check2" value="Delete" ><br></td>
</tr>
