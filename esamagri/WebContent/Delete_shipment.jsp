...
<html lang="en">
  <head>
    ...
    <title>E-Courier/Delete-Shipment</title>
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-truck"></i> Delete Shipment</h3>
</div>
			</div>
              <!-- page start-->
            ...
            <form action="#" method="post">
              <table width="401" height="79" cellpadding="2" cellspacing="1">
                <tr>
                  <td width="121" height="32" scope="col">Shipment Bill No:</td>
                  <td width="267" scope="col"><input class="form-control" id="inputdefault" type="text"></td>
                </tr>
                
                <tr><br>
      <td colspan="5" align="center">
<input type="submit" class="btn btn-primary btn-danger" value="Delete"></td>
    </tr>
