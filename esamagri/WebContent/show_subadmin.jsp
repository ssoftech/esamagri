<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.subadmin_dtls_bean"%>
    <%@page import="model.subadmin_dtls_model"%>
...
<br>
                ...
                <h6 class="widgettitle">subadmin </h6>
                
                
                  <%try
{
ArrayList<subadmin_dtls_bean> ar=subadmin_dtls_model.showsub();
if(ar!=null)
{%><div > 
             ...
             <% Iterator<subadmin_dtls_bean> it=ar.iterator();
	
	while(it.hasNext())
	{
		subadmin_dtls_bean ob=it.next();
