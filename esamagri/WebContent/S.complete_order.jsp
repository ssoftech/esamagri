...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.complete_order_bean"%>
    <%@page import="model.complete_order_modeldb"%>
...
<div class="mainwrapper">
  ...
  <h6 align="center"  class="widgettitle" style="margin-left:-20px; width: 1060px">Complete ORDER </h6><br>
   <%try
{
ArrayList<complete_order_bean> ar=complete_order_modeldb.completeorderdetails();
if(ar!=null)
{%><div><table class="table table-bordered table-hover" style="margin-left: -20px;"><tr><th>ORDER_ID</th><th>ADDRESS</th><th>ORDER_AMOUNT</th><th>ORDER_DATE</th><th>PAYMENT_TYPE</th><th>ORDER_STATUS</th>
 <th>Email</th><th>name</th><th>Supplier_id</th>
  </tr>
	<% Iterator<complete_order_bean> it=ar.iterator();
	
	while(it.hasNext())
	{
		complete_order_bean ob=it.next();
