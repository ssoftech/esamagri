...
<div class="mainwrapper">
  ...
  <div id= "apDiv1" >
  <h6 align="center"  class="widgettitle" style="margin-left:0px; width: 798px">ALL SUB CATEGORY </h6><br>
<table  class="table responsive"  style="margin-left:0px; width: 820px"><tr><th></th><th>sub category name</th>  <th>edit</th><th>delete</th></tr></table>
<%Connection con=Db.Condb();
String sql="select SUBCATEGORY_NAME from subcategory";
...
<% while (rs.next()){
	 ...
	 String cat_name=rs.getString("SUBCATEGORY_NAME");%>
<table class="table table-bordered table-hover" style="margin-left:0px; width: 820px">
<tr>
<td><%=cat_name%></td>
<td><a href="Edit_cat.jsp?pid=<%=rs.getString("SUBCATEGORY_NAME")%>" >Edit </a></td>
<td><a href="Edit_cat.jsp?pid=<%=rs.getString("SUBCATEGORY_NAME")%>" >Delete </a></td>
</tr></table>
<%}
%>
</div>
