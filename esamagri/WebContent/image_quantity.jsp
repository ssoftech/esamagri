...
<%try{
	 Connection con = Db.Condb();
                   int Product_id=Integer.parseInt(request.getParameter("product_id"));
                    ...
                    String sql33="select t.file_name from image t inner join products p on t.PRODUCT_ID=p.PRODUCT_ID where p.PRODUCT_ID=?";
                    PreparedStatement ps33=con.prepareStatement(sql33);
                	ps33.setInt(1,Product_id);
                	ResultSet rs33=ps33.executeQuery();
                	while(rs33.next()){
                    
                    
                    
                    String filename=rs33.getString(1);
    ...
    <div class="content-wrapper">	
		...
		<%  
				...
				<div>	<b> Seller name :<a href="retailer_product.jsp?seller=<%=supplier_id%>&product_id=<%=Product_id%>"><%=supplier_id%></a>  </b>  </div>
					...
					<div class="product-stock">Out Stock</div>
					<hr>
