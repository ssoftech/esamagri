...
function check()
{  
var x=document.getElementById("category_name").value;
if(x.length==0)
{
...
{
var xmlhttp;
var k=document.getElementById("category_name").value;

var urls="Check_Category.jsp?ver="+k;
    ...
    <div class="rightpanel">
        ...
        <!-- <form style="" ><table width="853" border="1"> -->
          <!-- <tr>
            <td width="850"> -->
            <div id="apDiv1" > 
         <form action="category" method="POST" name="ff" onSubmit="return check();">
            <table style="margin-left: 200px; margin-top: 50px">
           <caption> <h3 align="center" style="margin:10px; border:double 5px #2910e6;
...
background-color:	#F08080 ">ADD CATEGORY </h3>
    </caption>
<tr>
  <td>CATEGORY CREATED</td>
  <td><input type="text" name="CATEGORY_DATE" id="CATEGORY_DATE" value="<%=new Date()%>">
 </td>
</tr>

<tr>
  <td>CATEGORY NAME</td>
  <td><input type="text" name="category_name" id="category_name" onKeyUp="varify()"/><div id="err"></div></td>
</tr>
...
String sql22="select CATEGORY_NAME from category";
...
while(rs22.next())
{
	...
	String cat_namee=rs22.getString("CATEGORY_NAME");%>

<div align="center"><table ><th>CATEGORY_NAME</th><th>EDIT</th><th>DELETE</th>
<tr><td><%=cat_namee %></td>
