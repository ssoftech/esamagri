...
<script type="text/javascript" src="js/custom.js"></script><script type="text/javascript"></script>
...
function check()
{  
var x=document.getElementById("subcategory_name").value;
if(x.length==0)
{
...
{
var xmlhttp;
var k=document.getElementById("subcategory_name").value;

var urls="Check_Subcategory.jsp?ver="+k;
...
function show_Date()
{
	...
	document.getElementById("SUBCATEGORY_DATE").value=new Date();
...
<div class="mainwrapper">
 ...
 <table width="853" border="1">
          ...
          <td width="850">
  -->      <div id="apDiv1"> 
       <form style="" action="sub_category" method="post" onsubmit="return check();">
  <table style="margin-left: 300px; margin-top: 40px">
    <caption>
     <h3 align="center" style="margin:10px"> ADD SUBCATEGORY</h3>
    </caption>
    <tr>
      <td>CATEGORY NAME</td>
...
<%} %>
    ...
    <tr>
      ...
      <td><input type="text" name="subcategory_name" id="subcategory_name" onkeyup="varify()"/><div id="err"></div>
      </td>
    </tr>
    
    <tr>
      <td>SUBCATEGORY CREATED</td>
      <td><input type="text" name="SUBCATEGORY_DATE" value="<%=new Date()%>">
    </tr>
