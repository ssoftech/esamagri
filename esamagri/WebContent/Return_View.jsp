...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="model.Return_order_modeldb"%>
...
<div class="mainwrapper">
  ...
  <div id= "apDiv1" style="margin-left:40px ; margin-top: 50px ">
   <form action="ExportToExcel" method="post">
    <h6 align="center"  class="widgettitle" style=" width: 1060px">PRODUCT RETURN </h6><br>
   <%try
{
...
<table class="table table-bordered table-hover">
          ...
          <tr> <th>Order ID</th> <th>Email</th> <th>Product Name</th><th>Supplier Id</th>
                             <th>Reason</th>
                             <th></th></tr>
	...
	<% Iterator<Return_order_bean> it=ar.iterator();
	
	while(it.hasNext())
	{
		Return_order_bean ob=it.next();
