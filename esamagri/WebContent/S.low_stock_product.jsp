...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.Low_stock_bean"%>
...
<div class="mainwrapper">
  ...
  <h6 align="center"  class="widgettitle" style="margin-left:0px; width: 1060px">low stock product </h6><br>
 <%try
{
...
<table class="table table-bordered table-hover">
          ...
          <tr><th>PRODUCT_NAME</th><th>SUPPLIER_ID</th><th>Color</th><th>Quantity</th></tr>
