...
<h3  align="center">Update Order Status</h3>
...
<form action="update_status" method="POST" >
			...
			<table><tr><td><select name="ORDER_STATUS" ><option value="select" selected>select</option>
 <% //String ORDER_STATUS_ID=request.getParameter("pid");
//System.out.println("ORDER_STATUS_ID is in update_status.jsp"+ORDER_STATUS_ID);
int order_details_id=Integer.parseInt(request.getParameter("oid"));
System.out.println("order_details_id"+order_details_id);

Connection con=Db.Condb();
String sql="Select  ORDER_STATUS_ID,ORDER_STATUS_NAME from order_status ";
...
{
%>
<% String name1=rs.getString("ORDER_STATUS_NAME");%>
		 <option value="<%=rs.getString("ORDER_STATUS_ID")%>"><%=name1%></option>
<%
}
%>
</select>
...
<tr><td><input type="hidden" name="order_id" value="<%=order_details_id %>"></td></tr>
<tr><td>
