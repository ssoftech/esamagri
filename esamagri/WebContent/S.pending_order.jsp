...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="bean.pending_order_bean"%>
    <%@page import="model.pending_order_modeldb"%>
...
<div class="mainwrapper">
  ...
  <h6 align="center"  class="widgettitle" style="margin-left:-20px; width: 1060px">Pending ORDER </h6><br>
   <%try
{
ArrayList<pending_order_bean> ar=pending_order_modeldb.pendingorderdetails();
if(ar!=null)
{%><div><table class="table table-bordered table-hover" style="margin-left: -20px;"><tr><th>ORDER_ID</th><th>ADDRESS</th><th>ORDER_AMOUNT</th><th>ORDER_DATE</th><th>PAYMENT_TYPE</th><th>ORDER_STATUS</th>
 <th>Email</th><th>name</th><th>Supplier_id</th>
	...
	<% Iterator<pending_order_bean> it=ar.iterator();
	
	while(it.hasNext())
	{
		pending_order_bean ob=it.next();
