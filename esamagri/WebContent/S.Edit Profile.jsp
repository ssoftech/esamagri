...
<div class="mainwrapper">
    ...
    <div class="header">
        <div class="logo">
            <a href="Dashboard.jsp"><img src="Images/Sub-Admin (2).png" alt="" /></a>
        </div>
            ...
            <ul class="nav nav-tabs nav-stacked">
              ...
              <!--   <li><a href="Messages.jsp"><span class="iconfa-envelope"></span> Messages</a></li> -->
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-book"></span> Other Pages</a>
                	<ul>
                        <li class="active"><a href="S.Edit Profile.jsp">Edit Profile</a></li>
...
String sql11="Select EMAIL_ID from sub_admin_info where USER_NAME=?";
...
if(rs11.next())
{
	...
	String sql1="Select FIRST_NAME,LAST_NAME,USER_NAME,EMAIL_ID,PASSWORD from sub_admin_info where EMAIL_ID=?";
                        ...
                        <div class="widgetbox profile-photo">
                            <div class="headtitle">
                                ...
                                <h4 class="widgettitle">Profile Photo</h4>
                                 <span class="profilethumb"><img src="subadmin_image?id=<%=email%>" height="200" width="150"></img></span>
                            </div>
