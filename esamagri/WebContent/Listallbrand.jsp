...
<div class="mainwrapper">
  ...
  <div id= "apDiv1" >
  <h6 align="center"  class="widgettitle" style="margin-left:0px; width: 785px">ALL BRAND </h6><br>
<table  class="table responsive"  style="margin-left:0px; width: 810px"><tr><th></th><th>Brand Name</th>  <th>Edit</th> <th>delete</th></tr></table>
...
<% while (rs.next()){
	 ...
	 String cat_name=rs.getString("BRAND_NAME");%>
<table class="table table-bordered table-hover" style="margin-left:0px; width: 810px">
<tr>
<td><%=cat_name%></td>
<td><a href="Edit_cat.jsp?pid=<%=rs.getString("BRAND_NAME")%>" >Edit </a></td>
<td><a href="Edit_cat.jsp?pid=<%=rs.getString("BRAND_NAME")%>" >Delete </a></td>
</tr></table>
<%}
%>
</div>
