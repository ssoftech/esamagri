 ...
 <div class="container">
 	...
 	<% try{
            	   Connection con= Db.Condb();
           					String sql2= "select p.PRODUCT_ID,p.PRODUCT_NAME,p.SALES_PRICE,i.FILE_NAME from products p inner join image i on p.PRODUCT_ID=i.PRODUCT_ID  order by p.SALES_PRICE>=100";
