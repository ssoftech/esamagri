...
<div class="mainwrapper">
 ...
 <form action="Order_status" method="post">
    ...
    <caption>
     <h3 align="center" style="margin:10px">Insert Order Status</h3>
    </caption>
    <tr>
        
    <td>Order Status Name </td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <td><input type="text" name="ORDER_STATUS_NAME"></td>    
